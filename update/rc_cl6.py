...
def lookevent(full_names):
    ...
    rc = onename.split('/')[-2]    
    #vv6
    f = open(f'/home/lwd/Result/update/pfx_event_brc_{org}_{rc}_v6.txt','w')
    as_result = defaultdict(int)
    ...
    f.close()
    #vv6
    f = open(f'/home/lwd/Result/update/as_event_brc_{org}_{rc}_v6.txt','w')
...
try:
    ...
    if True:
        ...
        for p in pfxs:
            ...
            #vv6
        f = open(f'/home/lwd/Result/update/pfx_event_tt_v6.txt','w')
    ...
    if True:
        ...
        for p in ass:
            ...
            #vv6
        f = open(f'/home/lwd/Result/update/as_event_tt_v6.txt','w')
