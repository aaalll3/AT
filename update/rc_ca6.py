...
def lookevent(full_names):
    ...
    rc = onename.split('/')[-2]    
    #vv6
    f = open(f'/home/lwd/Result/update/pfx_event_attr_brc_{org}_{rc}_v6.txt','w')
    as_result = defaultdict(int)
    ...
    f.close()
    #vv6
    f = open(f'/home/lwd/Result/update/as_event_attr_brc_{org}_{rc}_v6.txt','w')
...
try:
    ...
    if True:
        ...
        for p in pfxs:
            ...
            pfx_ww.update(p[6])
            #vv6
        f = open(f'/home/lwd/Result/update/pfx_event_attr_av_v6.txt','w')
    ...
    if True:
        ...
        for p in ass:
            ...
            as_ww.update(p[6])
            #vv6
        f = open(f'/home/lwd/Result/update/as_event_attr_av_v6.txt','w')
