...
stamp = time.time()
                                            #DATE
logging.basicConfig(filename=f'./log/log_{20201215}_{stamp}.log',level=logging.DEBUG)
...
class Extor:
    ...
    def select(self,name):
        ...
        time=name[2]
                                        #DATE
        if time =='0000' and date == '20201215':
            return True
        else: 
            return False
...
if __name__ == '__main__':
    ...
    debug_target = os.path.abspath('../RIB.test/')
                                                        #DATE
    debug_saving = os.path.abspath('../RIB.test/path/pc20201215')
